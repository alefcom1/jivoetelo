 ...
 *
 * Замер вносится прямо здесь, кнопкой в шапке карточки. Раньше за этим
 * приходилось идти в «Профиль» → «Измерения» — три нажатия ради одного
 * числа, которое человек держит в голове ровно те несколько секунд, пока
 * стоит на весах. Карточка показывается и без единого замера: до правки
 * она молча исчезала, и записать первый вес с главного экрана было негде.
 */
