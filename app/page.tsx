...
export default function Home() {
  ...
  return <main>
    ...
    {/* Числа берутся из кода, а не переписаны в текст.
        Раньше здесь стояли «20 разборов по фото, 40 по тексту и 15 подсказок»
        буквами — и уже разошлись с действительностью: распознавание весов
        появилось позже и в этот список не попало. Страница, обещающая не тот
        лимит, хуже страницы, не обещающей ничего, поэтому лимиты и тарифы
        подставляются из PLAN_LIMITS и TARIFFS. */}
