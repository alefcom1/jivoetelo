...
export default function Home() {
  ...
  return <main>
    ...
    <section className="price">
      ...
      <div>
        <p>
          Дневник, разбор фотографий, план, вес, обзоры и подсказки доступны бесплатно
          и целиком. Ограничение одно и техническое — сколько раз в сутки можно обратиться
          к распознаванию:
        </p>
        ...
        <p>
          Столько не набирает никто, кто ведёт дневник для себя: лимит стоит против чужого
          скрипта, а не против вас. Записывать еду руками можно без ограничений всегда —
          в том числе когда дневной лимит исчерпан.
        </p>
        <p>
