...
function PlanResult({ goal, reason, minor, targets, fan, protein, targetWeightKg }: {
  ...
  return <div className="plan-result">
    ...
    <div className="plan-cta">
      ...
      {/* «Бесплатно и без подписки» стояло здесь до августа 2026 и пережило
          смену модели — то есть стало неправдой на самой посещаемой странице
          сайта. Подписка появилась, и узнавать о ней через тридцать дней,
          в момент отказа, человек не должен: он читал обратное здесь.
          Сказано сразу и целиком, включая приятную половину — дневник
          остаётся открытым в любом случае. */}
      <p className="plan-quiet">
        Первый месяц — бесплатно и целиком, без карты. Дальше платным становится только разбор
        по фото и голосом; дневник, план и вес открыты всегда. <a href="/tarify">Про цену →</a>
      </p>
    </div>
