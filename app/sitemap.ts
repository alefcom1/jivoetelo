...
const STATIC_PAGES: StaticPage[] = [
  ...
  { path: "/pro/kak-rabotaet", priority: 0.6, changeFrequency: "monthly" },
  { path: "/pro/dannye", priority: 0.6, changeFrequency: "monthly" },
  { path: "/pro/voprosy", priority: 0.6, changeFrequency: "monthly" },
  { path: "/pro/pamyatka", priority: 0.6, changeFrequency: "monthly" },
