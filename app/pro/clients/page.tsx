    ...
    if (!profile) {
      return (
        <main className="pro-cab-gate">
          <h1>Кабинет специалиста</h1>
          <p>
            Этот раздел — для специалистов «Живого Тела Pro». Кабинет бесплатный; чтобы его
            открыть, оставьте заявку — её читает человек, и отвечаем мы в течение рабочего дня.
          </p>
