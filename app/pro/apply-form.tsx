  ...
  if (state.status === "success") {
    return (
      <div className="pro-done">
        ...
        <p>Ответим на указанный адрес в течение рабочего дня и откроем кабинет.</p>
        {/* Причина названа прямо, а не спрятана за «мы вам перезвоним»:
            специалист имеет право знать, чего именно ждёт. */}
        <p>Заявку читает человек — кабинет открывает записи о питании других людей, и раздавать такой доступ по нажатию кнопки было бы неправильно.</p>
      </div>
    );
  }
