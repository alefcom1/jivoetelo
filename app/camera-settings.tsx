...
const OPTIONS: Array<{ key: CameraPrefKey; label: string; note: string }> = [
  ...
  },
  {
    ...
    note: "Рамка зеленеет, когда камера узнаёт еду. Распознавание идёт на этом устройстве: при первом открытии камеры скачивается около шести мегабайт. Поэтому по умолчанию выключено — на мобильном интернете эта загрузка замедляет сам разбор еды.",
  },
];
