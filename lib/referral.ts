 ...
 * пришедшего от заведённого. Под платной моделью это стало важнее, а не
 * мягче: месяц доступа теперь стоит настоящих денег на счёте за модель.
 */
export const REFERRAL_REWARD_AFTER_DAYS = 7;

/**
 * Сколько дней доступа получает каждый — и приглашённый, и пригласивший.
 *
 * Ровно месяц, столько же, сколько длится пробный период и сколько стоит
 * месячный тариф. Три разных числа человек в голове держать не станет, а одно
 * и то же «месяц» он запомнит с первого раза. Ограничения на число
 * приглашений нет: сколько привёл — столько месяцев.
 */
