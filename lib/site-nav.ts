...
export const NAV_SECTIONS: NavSection[] = [
  ...
  { href: "/blog", label: "Журнал" },
  // «О нас» — отдельная страница, а не якорь. Якорем оно вело на блок
  // `#principles` главной, то есть в раздел про диапазоны: ссылка формально
  // работала (потому и не падал тест), но человек, нажавший «О нас», ждёт
  // рассказ о проекте, а получал абзац о методике посреди лендинга.
