...
export const ARTICLES: Article[] = [
  ...
  {
    slug: "sozhgla-na-trenirovke-samaya-dorogaya-oshibka-v-podschete",
    kicker: "Разбор",
    title: "«Сожгла на тренировке» — самая дорогая ошибка в подсчёте",
    titleShort: "«Сожгла на тренировке»",
    description:
      "Тренажёр показывает «270 ккал», а реально расходуется 220 — и один протеиновый батончик " +
      "перекрывает всю тренировку целиком. Считаем разницу цифрами.",
    lead:
      "Экран эллипса гаснет и пишет «270 ккал» — и число тут же превращается в разрешение съесть " +
      "что-то в награду. На самом деле экран считает не то, что нужно знать: валовый расход, а не " +
      "то, что добавилось сверх состояния покоя. Разбираем разницу на цифрах — и во что она " +
      "обходится дневному балансу.",
    published: "2026-08-07",
    minutes: 3,
    updated: "2026-08-07",
    sources: [],
    heroImage: null,
    heroAlt:
      "Экран кардиотренажёра с цифрой сожжённых калорий рядом с раскрытым протеиновым батончиком на обёртке",
  },
];
