...
const SHOTS = [
  ...
  },
  {
     ...
     * кончается на 126-й.
     *
     * Высота обрезана по промежутку между карточками (1272–1291 от верха
     * кадра) — чтобы снимок кончался целой карточкой «Обед», а не половиной
     * следующей. Если экран «Сегодня» перевёрстывают, эти числа надо снять
     * заново, иначе кадр обрежется по живому.
     */
    crop: { left: 480, top: 126, width: 1919, height: 1282 },
    width: 1500,
  },
  {
